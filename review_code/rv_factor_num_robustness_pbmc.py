...
for NUM_COMPONENTS in compenents_list:
    ...
    pca_scores_varimax_df_merged.to_csv('/home/delaram//sciRED/review_analysis/pbmc_varimax_scores_numcomp_'+str(NUM_COMPONENTS)+'.csv')
    varimax_loading_df.to_csv('/home/delaram//sciRED/review_analysis/pbmc_varimax_loading_numcomp_'+str(NUM_COMPONENTS)+'.csv')
