...
#### make a loop to find the optimal number of components: 5, 10, 20, 30, 50 
compenents_list = [5, 10, 20, 30, 50]
for NUM_COMPONENTS in compenents_list:
    ...
    pca_scores_varimax_df_merged.to_csv('/home/delaram//sciRED/review_analysis/factor_robustness/humanliver_varimax_scores_numcomp_'+
                                        str(NUM_COMPONENTS)+'.csv')
    varimax_loading_df.to_csv('/home/delaram//sciRED/review_analysis/factor_robustness/humanliver_varimax_loading_numcomp_'+
                              str(NUM_COMPONENTS)+'.csv')
    ...
    vis.plot_FCAT(fcat_matched, x_axis_label=x_labels_matched, title='', color='coolwarm',
                                    ...
                                    save=False, save_path='../Plots/mean_importance_df_matched.pdf')
