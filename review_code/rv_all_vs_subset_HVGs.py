...
#data = data[:,gene_sums != 0] ## cells, genes
data_numpy = data.X.toarray()
...
if SELECT_HVG:
    ...
    data = data[:,gene_idx]
    num_genes  = data.shape[1] # 18890 - (29065, 18890)
    print('num_genes: ', num_genes)


### track the run time of the script
...
'''
pca_scores_varimax_df_merged.to_csv('/home/delaram//sciRED/review_analysis/pca_scores_varimax_df_merged_lupusPBMC_numgenes_'+str(num_genes)+'.csv')
varimax_loading_df.to_csv('/home/delaram//sciRED/review_analysis/varimax_loading_df_lupusPBMC_numgenes_'+str(num_genes)+'.csv')
'''
...
print(f'Run time: {run_time_minutes:.2f} minutes')
